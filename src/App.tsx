    ...
    <>
      <div className='flex flex-col min-h-screen w-full overflow-hidden bg-fixed bg-neutral-50 text-neutral-800 selection:text-neutral-700 selection:bg-neutral-300
        ...
        <div className='flex-grow w-full max-w-3xl mx-auto mt-20 px-5'>
          ...
          <h1 className='text-3xl font-medium mt-6 text-neutral-800'>
            Hi, I'm Farhan
          </h1>
        ...
        <footer className='relative items-center flex justify-between w-full max-w-3xl mx-auto py-7 mt-10 text-sm text-black/50'>
          ...
          <div className='absolute  h-px w-full bg-[#e8e8e8] top-0 right-0'></div>
        </footer>
      </div>
